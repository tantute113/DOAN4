...
@media (max-width: 767px) {
    ...
    <body>
        <div class="container">
            <div class="row">
                <div></div>
                <img id="postcard" style="width: 400px;height: 550px;" src="https://media.vogue.fr/photos/5c361444cf01b06e14609106/master/w_1600%2Cc_limit/monogramme_3408.jpeg" alt="postcard" class="img-responsive move">
                <div id="content" >
                    <h1>Đăng ký</h1>
                    ...
                    <form method="POST" action="{{route('sms')}}" >
                        ...
                        <div class="form-group">
                            ...
                            @if($errors->has('TK_SDT')) 
                            <span style="color: red ;"> {{ $errors->first('TK_SDT') }}*</span>
                            @else
                            <label for="usermail" class="iconic mail-alt">Số điện thoại<span class="required">*</span></label>
                              @endif
                            <input type="text" class="form-control" name="TK_SDT" id="username" value="{{old('TK_SDT')}}"  placeholder="Số điện thoại ,hãy nhập vào">
       ...
       <label for="usermail" class="iconic mail-alt">Mật khẩu<span class="required">*</span></label>
         @endif
                            ...
                            <input type="password" class="form-control" value="{{old('password')}}" name="password" id="usermail" placeholder="Mật khẩu ,hãy nhập vào" >
                        ...
                        <div class="form-group">
                            ...
                            @else
                            <label for="usermail" class="iconic mail-alt">Tên<span class="required">*</span></label>
                              @endif
                            <input type="text" class="form-control" name="ten" id="subject" value="{{old('ten')}}"  placeholder="Tên ,hãy nhập vào ">
                        ...
                        <div class="form-group">
                            ...
                            @else
                            <label for="usermail" class="iconic mail-alt">Địa chỉ<span class="required">*</span></label>
                              @endif
                            <textarea name="diachi" id="message"class="form-control" rows="3" placeholder="Địa chỉ ,hãy nhập vào" >{{old('diachi')}}</textarea>
