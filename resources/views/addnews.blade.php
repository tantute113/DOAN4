...
<form style="margin-top:90px;" method="post" enctype="multipart/form-data" action="{{route('admin.news.addpost')}}">
  ...
  @endif --}}
      ...
      <div class="col">
        <div class="form-outline">
          <input type="text" name='ten' id="form6Example1" value="{{old('ten')}}" placeholder="Tiêu đề" class="form-control" />
    ...
    <div class="form-outline mb-2">
      <select class="form-select" name="mgg" aria-label="Default select example">
       
        @foreach ($mgg as $mgg)
    
        <option  value="{{$mgg->MGG_MA}}" >{{$mgg->MGG_TEN}}</option>
